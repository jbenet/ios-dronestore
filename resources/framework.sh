...
FRAMEWORK_DIR="build/Framework/$FRAMEWORK_NAME.framework"
...
# are called
FRAMEWORK_INPUT_ARM_FILES="build/$BUILD_TYPE-iphoneos/libiDrone.a"
FRAMEWORK_INPUT_I386_FILES="build/$BUILD_TYPE-iphonesimulator/libiDrone.a"
